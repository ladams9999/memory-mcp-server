...
class TestMemoryCreation:
    ...
    def test_memory_creation_with_required_fields_only(self):
        ...
        memory = Memory(content="Test memory content", context="test_context")
...
class TestMemoryValidation:
    ...
    def test_content_max_length_validation(self):
        ...
        assert any(
            error["loc"] == ("content",)
            and "at most 10000 characters" in str(error["msg"])
            for error in errors
        )
    ...
    def test_context_max_length_validation(self):
        ...
        assert any(
            error["loc"] == ("context",)
            and "at most 255 characters" in str(error["msg"])
            for error in errors
        )
...
class TestMemorySerialization:
    ...
    def test_from_dict_missing_timestamp(self):
        ...
        data = {"content": "Test memory", "context": "test_context"}
...
class TestMemoryEdgeCases:
    ...
    def test_metadata_with_complex_data(self):
        ...
        memory = Memory(content="test", context="test", metadata=complex_metadata)
